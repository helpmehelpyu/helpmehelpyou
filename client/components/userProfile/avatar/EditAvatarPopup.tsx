...
export default function EditAvatarPopup({
  ...
  return (
    <PopupOverlay setShowPopup={setShowEditAvatarPopup}>
      <div className="fixed flex flex-col space-y-2 w-2/5 items-center top-0 bottom-0 right-0 left-0 m-auto p-2 bg-white rounded z-20 overflow-auto transparent-scrollbar aspect-square box-border">
        <div className="m-auto">
          {avatarPreview !== '' || currentAvatar !== '' ? (
            <Image
              ...
              width={300}
              alt="Avatar"
              className="aspect-square m-auto rounded-full sm:mb-10 select-none"
            ></Image>
          ) : (
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 justify-center sm:space-x-2 m-auto">
            <button
