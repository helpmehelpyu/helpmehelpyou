      ...
      <div className="fixed p-10 left-0 right-0 top-0 bottom-0 m-auto rounded bg-white h-5/6 w-1/3 space-y-10 min-w-min overflow-auto">
        <div className="flex flex-col w-full h-full justify-center">
          ...
          <button
            ...
            className="m-2 mt-8 w-20 p-1 text-red-600 border-2 rounded border-red-600  hover:bg-slate-200 hover:cursor-pointer"
          >
            Delete
          </button>
          <p className="text-red-500 text-xs mx-2 mb-2 px-1">{deleteErrors}</p>
        </div>
      </div>
    </PopupOverlay>
  );
